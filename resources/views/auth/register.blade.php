            ...
            <div class="col-md-8  " style=" padding: 10px; margin-left: auto; margin-right: auto ">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="surname" placeholder="{{ __('surname') }}" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ old('surname') }}" required  autofocus>
